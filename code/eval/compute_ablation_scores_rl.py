...
for game in ['beamrider', 'breakout', 'enduro', 'seaquest', 'spaceinvaders']:
    ...
    filenames = [game + postfix1 + game + "_64_trex" + postfix2, 
              game + postfix1 + game + "_64_trex_mean" + postfix2, 
              game + postfix1 + game + "_64_ss_map" + postfix2, 
              game + postfix1 + game + "_64_ss_mean" + postfix2, 
              game + postfix1 + game + "_64_all" + postfix2,
