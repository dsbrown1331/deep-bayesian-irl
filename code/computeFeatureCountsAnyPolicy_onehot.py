...
def get_policy_feature_counts(env_name, checkpointpath, num_rollouts, fixed_horizon):
...
if __name__=="__main__":
    ...
    print(env_name)
    print("*"*10)
    returns, ave_feature_counts = get_policy_feature_counts(env_name, checkpointpath, args.num_rollouts, args.fixed_horizon)
