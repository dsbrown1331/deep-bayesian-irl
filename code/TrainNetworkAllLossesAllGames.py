...
class Net(nn.Module):
    def __init__(self, ENCODING_DIMS, ACTION_DIMS):
        ...
        self.inverse_dynamics2 = nn.Linear(ENCODING_DIMS, ACTION_DIMS)
        self.forward_dynamics1 = nn.Linear(ENCODING_DIMS + ACTION_DIMS, (ENCODING_DIMS + ACTION_DIMS) * 2)
        self.forward_dynamics2 = nn.Linear((ENCODING_DIMS + ACTION_DIMS) * 2, (ENCODING_DIMS + ACTION_DIMS) * 2)
        self.forward_dynamics3 = nn.Linear((ENCODING_DIMS + ACTION_DIMS) * 2, ENCODING_DIMS)
...
def learn_reward(reward_network, optimizer, training_inputs, training_outputs, training_times, training_actions, num_iter, l1_reg, checkpoint_dir):
    ...
    for epoch in range(num_iter):
        ...
        for i in range(len(training_labels)):
            ...
            ###DB: decoded1 = reward_network.decode(z1)
            #print("DECODED SHAPE:")
            ...
            #print(traj_i.shape)
            #print(traj_i.type())
            ###DB: decoded2 = reward_network.decode(z2)
