...
eval_policies = ['human_good_truncated.txt', 'human_everyother_truncated.txt', 'human_holdnfire_truncated.txt', 'human_shootbarriers_truncated.txt', 'human_flee_truncated.txt', 'human_hide_truncated.txt', 'human_miss_truncated.txt']
