...
W = helper.get_weightchain_array("../../mcmc_data/" + args.env_name + "_aux_mcmc.txt")
...
for eval in eval_policies:
    #print("-"*20)
    #print("eval", eval)
    returns, fcounts = helper.parse_avefcount_array('../../policies/' + args.env_name +'_' + eval + '_fcounts_auxiliary.txt')
