...
eval_policies = ['human_good.txt', 'human_periodic.txt', 'human_neutral.txt', 'human_ram.txt']
...
for eval in eval_policies:
    fcounts, returns, lengths, all_fcounts = helper.parse_fcount_policy_eval('/home/dsbrown/Code/deep-bayesian-irl/enduro_eval_policies/' + eval)
