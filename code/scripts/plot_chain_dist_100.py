...
for eval in eval_policies:
    #print("-"*20)
    #print("eval", eval)
    returns, fcounts = helper.parse_avefcount_array('../../policies/' + args.env_name +  '_' + eval + '_fcounts_100.txt')
...
plt.legend( )
plt.tight_layout()
plt.savefig("/home/dsbrown/Dropbox/NeurIPS19SafetyWorkshop/figs/" + args.env_name + "_mcmc_return_dist_100.png")
...
plt.legend( )
plt.tight_layout()
plt.savefig("/home/dsbrown/Dropbox/NeurIPS19SafetyWorkshop/figs/" + args.env_name + "_gt_return_dist_100.png")
