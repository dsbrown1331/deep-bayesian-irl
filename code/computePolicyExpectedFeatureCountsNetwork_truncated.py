...
def get_policy_feature_counts(env_name, checkpointpath, feature_net, num_rollouts, max_length, no_op=False):
...
if __name__=="__main__":
    ...
    parser.add_argument('--checkpointpath', help="path to policy to evaluate")
    ...
    print(env_name)
    print("*"*10)
    returns, ave_feature_counts, fcounts, num_steps = get_policy_feature_counts(env_name, args.checkpointpath, feature_net, args.num_rollouts,args.max_length, args.no_op)
